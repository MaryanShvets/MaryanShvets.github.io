<?
	...
	$api->query(" INSERT INTO `app_payments`( `order_id`, `date_create`, `pay_channel`, `type`, `email`, `pay_amount`, `pay_currency`, `order_desc` ) VALUES ('$amo', '$date_create_sql', '$system', 'invoice', '$email', '$amount', '$currency', '$desc' ) ");
