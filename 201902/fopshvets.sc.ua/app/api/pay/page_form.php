    ...
    <div class="row mb-60">
      ...
      <div class="col-md-6 bg-w">
          ...
          <div class="row pb-60">
            <div class="col-md-3"></div>
            <div class="col-md-6">
               <a target="_blank" href="<?=$url_pay_usd;?>"><h3 class="text-center">Оплатить <?=$priceCheck;?> $</h3></a>
               <a target="_blank" href="<?=$url_pay_uah;?>"><h3 class="text-center">Оплатить <?=$priceCheckUAH;?> грн.</h3></a>
               <a target="_blank" href="<?=$url_pay_rub;?>"><h3 class="text-center">Оплатить <?=$product['amoPrice'];?> р.</h3></a>
            </div>
          </div>
