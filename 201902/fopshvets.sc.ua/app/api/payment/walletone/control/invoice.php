<?php
    ...
    // Этот файл принимает номер счета и создает платеж в Walletone.
    ...
    $api->query(" UPDATE `app_payments` SET `pay_system`='$pay_system', `pay_id`='$pay_id',`status`='$status',`card_from`='$card_from',`card_type`='$card_type', `date_mod`='$date_mod' WHERE `id` = '$invoice_id' ");   
